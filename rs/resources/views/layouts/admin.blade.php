            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @else
                        <a class="nav-link" href="{{ route('reg_inst') }}">{{ __('Зарегистрировать учебное заведение') }}</a>

                        <a class="nav-link" href="{{ route('teacher') }}">{{ __('Кабинет преподавателя') }}</a>

                        <a class="nav-link" href="{{ route('admin') }}">{{ __('Административная панель') }}</a>
