        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @{{ message }}
<div class="raz">
                    <table  title="На сколько процентов выполнена лабораторная работа" class="datatable" id="datatable">
                        <thead>
                            <tr>
                                <th>ФИО</th>
                                ...
                                <?php
                                for ($i = 1; $i <= $rs->number_labs; $i++)
                                {
                                    echo '<th>Лабораторная № ', $i;
                                    echo '</th>';
                                }
                                ?>
                            </tr>
                        ...
                        <tr>
                            ...
                            <td  onblur="update({{$id_row_lecture->id}}, $(this).text(),'sum_points')"  id="{{$id_row_lecture->id}}">
                                <?php
                                $sum = 0;
                                for ($i = 0; $i <= $rs->number_labs; $i++)
                                {
                                    $sum = $sum + $id_row_lecture->{'date_' . $i};

                                }
                                echo round(($sum / 100) * ($rs->all_points_labs / $rs->number_labs), 1);
                                ?>
